...
export const Key = ({ className, children, variant = "tl", isBottomRow }: {
  ...
  const shadowVariants = {
    tl: {
      ...
      base: "shadow-[1px_1px_0px_0.7px_#52525b_inset,0px_6px_10px_-3px_#f2f2f2]"
    },
    rb: {
      hover: "hover:shadow-[-1px_-1px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08)]",
      base: "shadow-[-1px_-1px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08),0px_6px_10px_-3px_#f2f2f2]"
    },
    tr: {
      hover: "hover:shadow-[-1px_1px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08)]",
      base: "shadow-[-1px_1px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08),0px_6px_10px_-3px_#f2f2f2]"
    },
    bl: {
      hover: "hover:shadow-[1px_-1px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08)]",
      base: "shadow-[1px_-1px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08),0px_6px_10px_-3px_#f2f2f2]"
    ...
    tbl: {
      ...
      base: "shadow-[1px_-1px_0px_0.5px_#52525b_inset,0.5px_0.5px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08),0px_6px_10px_-3px_#f2f2f2]"
    },
    tbr: {
      hover: "hover:shadow-[-1px_-1px_0px_0.5px_#52525b_inset,-0.5px_0.5px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08)]",
      base: "shadow-[-1px_-1px_0px_0.5px_#52525b_inset,-0.5px_0.5px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08),0px_6px_10px_-3px_#f2f2f2]"
    ...
    full: {
      ...
      base: "shadow-[1px_1px_0px_0.5px_#52525b_inset,-1px_-1px_0px_0.5px_#52525b_inset,0.5px_-0.5px_0px_0.5px_#52525b_inset,-0.5px_0.5px_0px_0.5px_#52525b_inset,_0px_6px_12px_rgba(255,255,255,0.08),0px_6px_10px_-3px_#f2f2f2]"
    },
  }
